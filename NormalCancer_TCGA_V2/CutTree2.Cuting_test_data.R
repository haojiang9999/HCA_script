...
hclust.Res <- hclust(dist(t(Trans.Rang1.cv2500), method="euclidean"), method="complete")
## Not good for dist(): "maximum","canberra","binary"
## Good for dist():"euclidean"="minkowski">"manhattan"

Cluster.Res <- pheatmap::pheatmap(Trans.Rang1.cv2500,annotation_col = COAD.pheno.tumor,
...
TCGAClusterSurv(Input.tb = Trans.Rang1.cv2500, hclust.res = hclust.Res, Col.anno = COAD.pheno[TumorID,], k = 7)
